...
class IRobot:
    ...
    def update(self) -> None:
        ...
        According to your network configuration, update should take
        between 10 and 100 msecs to be performed
        """
        ...
    ...
    def enableCamera(self, enable: bool = True) -> None:
        """
        Enable/Disable camera to fetch image stream on each update()
    ...
    def stop(self) -> None:
        """
        Stops motors and turns LED off
        """
        ...
